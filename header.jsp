        ...
        <div class="container" >
            <div class="navbar-header my-1"> <!-- Header navigation-->
                <a href="#" class="pull-left">
                    <img src="images/Banner_Hit.png" alt="HIT Haldia" width="70px" height="70px"/>
                </a>
                    <a class="navbar-brand" href="#"><h1>E Tender Procurement Solution</h1></a> <!-- Library Name fixed-->
                    <a href="#"><p> A DMCE Project</p></a>
            </div>
