...
<body>
	...
	<div class="clearfix hidden-sm hidden-xs" style="color:white;background-color: green; margin-top:-15px; margin-bottom: 12px"><marquee>Welcome to E Tender Procurement Solution</marquee>
   ...
   <div class="col-md-8">
    <div class="marquee" style="border:2px black hidden; background-color:white">
        ...
        <div class="marquee-content" style="align:center; padding-top:200px;min-height:750px;background-color:cyan">
     		<h1><center>Hello User, Welcome to E-Tender Procurement Solution</center></h1>
     		<h2><center>Here you can manage tendors, view tendors and assign bids for tendors</center></h2>
     		<h3><center>Go to about menu for exploring sites</center></h3>
     		<h3><center>You can also update profile, change password and explore more things</center></h3>
