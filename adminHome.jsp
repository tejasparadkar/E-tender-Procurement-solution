   ...
   <div class="col-md-8">
    <div class="marquee" style="border:2px black hidden; background-color:white">
        ...
        <div class="marquee-content" style="align:center; padding-top:200px;min-height:750px;background-color:cyan">
     		<h1><center>Hello Admin, Welcome to E-Tender Procurement Solution</center></h1>
     		<h2><center>Here you can add tenders, manage vendors and assign bids to vendors</center></h2>
     		<h3><center>Go to about menu for exploring sites</center></h3>
     		<h3><center>Notices can be added, updated and deleted as well</center></h3>
      </div>
     </div>
     </div>
