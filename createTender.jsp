...
<html lang="en">
  <head>
    ...
    <title>E Tender Procurement</title>
...
<body>
	...
	<div class="clearfix hidden-sm hidden-xs" style="color:white;background-color: green; margin-top:-15px; margin-bottom: 12px"><marquee>Welcome to E Tender Procurement Management </marquee>
